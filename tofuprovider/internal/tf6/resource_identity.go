...
func namedIdentitySchemasSeq(proto map[string]*tfplugin6.ResourceIdentitySchema) iter.Seq2[string, providerschema.IdentitySchema] {
	return common.MapSeq2(maps.All(proto), func(name string, protoSchema *tfplugin6.ResourceIdentitySchema) (string, providerschema.IdentitySchema) {
...
func identityAttributesSeq(proto []*tfplugin6.ResourceIdentitySchema_IdentityAttribute) iter.Seq2[string, providerschema.IdentityAttribute] {
	return common.MapSeqToSeq2(slices.Values(proto), func(protoAttr *tfplugin6.ResourceIdentitySchema_IdentityAttribute) (string, providerschema.IdentityAttribute) {
