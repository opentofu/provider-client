...
// Source: github.com/opentofu/provider-client/tofuprovider/grpc/tfplugin6 (interfaces: ProviderClient)
//
// Generated by this command:
//
//	mockgen -destination client_mock_test.go -package tf6_test github.com/opentofu/provider-client/tofuprovider/grpc/tfplugin6 ProviderClient
//

// Package tf6_test is a generated GoMock package.
package tf6_test
...
import (
	...
	tfplugin6 "github.com/opentofu/provider-client/tofuprovider/grpc/tfplugin6"
...
func (m *MockProviderClient) ReadStateBytes(ctx context.Context, in *tfplugin6.ReadStateBytes_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[tfplugin6.ReadStateBytes_ResponseChunk], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[tfplugin6.ReadStateBytes_ResponseChunk])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
